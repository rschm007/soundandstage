	<div>
		...
		<script>
			$(document).ready(function() {
				...
				// enter key handler
				$("#default-search").on('keypress', function(e) {
		...
		<form id="posts-search" class="flex flex-row justify-center items-center w-full my-12">
			...
			<div class="relative w-[20rem] md:w-[30rem]">
				...
				<input type="search" id="default-search" name="search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-[#e4c28b] focus:border-[#e4c28b]" placeholder="Search <?php single_post_title() ?> names, directors, theatres..." required>
